...
import Main_part.Animals.Animal;
import Main_part.Animals.Camel;
import Main_part.Animals.Cat;
import Main_part.Animals.Dog;
import Main_part.Animals.Donkey;
import Main_part.Animals.Hamster;
import Main_part.Animals.Horse;
        ...
        try (Scanner in = new Scanner(System.in, "ibm866"); Counter count = new Counter()) {
            ...
            while (flag) {
                try {
                    ...
                    System.out.println("Ошибка: неверный формат ввода. Попробуйте ещё раз.");
